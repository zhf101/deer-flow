...
import { DatabaseIcon, GlobeIcon, PlusIcon, Trash2Icon, NetworkIcon, ListIcon, EyeIcon } from "lucide-react";
        ...
        {steps.length === 0 ? (
          ...
          <div className="space-y-3">
             {steps.map((step, idx) => (
                ...
                >
                    <div className="size-10 rounded-full bg-muted flex items-center justify-center shrink-0 group-hover:bg-primary/10 transition-colors">
                                ...
                                {(step.type === 'HTTP' || step.type === 'AUTH_HTTP') ? (
                                    ...
                                    <>
                                        ...
                                        <span className="font-mono text-[11px] truncate">
                                            {step.description?.startsWith('Raw SQL:') ? step.description.substring(8) : (step.sqlTemplateCode || '未配置 SQL')}
                                        </span>
                                    </>
                                )}
                            </div>
