...
<FileTree>
  <FileTree.Folder name="skills/" defaultOpen>
    <FileTree.Folder name="public/" defaultOpen>
      <FileTree.Folder name="bootstrap/" defaultOpen>
        <FileTree.File name="SKILL.md" />
      </FileTree.Folder>
      <FileTree.Folder name="code-documentation/">
        <FileTree.File name="SKILL.md" />
      </FileTree.Folder>
...
| Skill                    | Description                                        |
| ------------------------ | -------------------------------------------------- |
| `bootstrap`              | Agent bootstrap and initialization workflow         |
| `find-skills`            | Discover and install skills from the community      |
